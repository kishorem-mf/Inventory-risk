...
def extract_info_query(query):
    extract_prompt_1 = f""" You are information processing module in supply chain analysis system which works on user query. Your task is to extract 3 points of infromation from the user query if present while following the instruction to process the information as required.
    ...
    3. If any of the value is not present then respond its value as "Not provided by user" as per smaple response format given.
    4. If user asks query that is based of current time, VERY IMPORTANT to use this data as current time : {current_time}
    """
